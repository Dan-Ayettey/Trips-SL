...
let Content={
    ...
    container:function () {
        ...
        let transportation_hive=`<div id="station_ecosystems_hive">
<span id="local_train" class="station_ecosystems_hive"><span class="right_arrow">&rightarrow;</span>Local</span><span id="inter_country" class="station_ecosystems_hive">Intercountry</span><span id="continental" class="station_ecosystems_hive">Continental<span class="left_arrow">&leftarrow;</span></span>
</div>`;
...
<section id="input_contents">
    ...
    <form autocomplete="off">
        <fieldset id="content_fieldset">
          ...
          <tr>
            <th id="transportation_title"   colspan="90%"> </th>
          </tr>
         <tr>
             <th id="convey_container_th" colspan="90%">
                 ${transportation_hive}
                </th>
          ...
          <tr>
           ...
           <th id="transport_localization" colspan="90%">
